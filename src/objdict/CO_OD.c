...
/*1600*/ {{0x4L, 0x63000110L, 0x63000210L, 0x63000310L, 0x63000410L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
/*1A00*/ {{0x4L, 0x61000110L, 0x61000210L, 0x61000310L, 0x61000410L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
/*1A03*/ {0x4L, 0x64010910L, 0x64010A10L, 0x64010B10L, 0x64010C10L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
/*1A04*/ {0x8L, 0x64000108L, 0x64000208L, 0x64000308L, 0x64000408L, 0x64000508L, 0x64000608L, 0x64000708L, 0x64000808L},
/*1A05*/ {0x6L, 0x20060310L, 0x200C0510L, 0x200A0308L, 0x200A0408L, 0x200C0308L, 0x200C0408L, 0x0000L, 0x0000L},
...
/*0x1026*/ const CO_OD_entryRecord_t OD_record1026[3] = {
           ...
           {(void*)&CO_OD_RAM.OSPrompt.stdOut, 0x66, 0x1 },
};
...
/*0x1804*/ const CO_OD_entryRecord_t OD_record1804[7] = {
           ...
           {(void*)&CO_OD_ROM.TPDOCommunicationParameter[4].compatibilityEntry, 0x05, 0x1 },
...
/*0x1805*/ const CO_OD_entryRecord_t OD_record1805[7] = {
           ...
           {(void*)&CO_OD_ROM.TPDOCommunicationParameter[5].compatibilityEntry, 0x05, 0x1 },
...
/*0x1806*/ const CO_OD_entryRecord_t OD_record1806[7] = {
           ...
           {(void*)&CO_OD_ROM.TPDOCommunicationParameter[6].compatibilityEntry, 0x05, 0x1 },
...
/*0x2002*/ const CO_OD_entryRecord_t OD_record2002[8] = {
           {(void*)&CO_OD_ROM.configPort[0].highestSubIndexSupported, 0x05, 0x1 },
           {(void*)&CO_OD_ROM.configPort[0].port, 0x05, 0x5 },
           {(void*)&CO_OD_ROM.configPort[0].outputMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[0].outputStartValue, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[0].inputMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[0].inputPullUp, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[0].inputPullDown, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[0].availableMask, 0x85, 0x2 },
};

/*0x2003*/ const CO_OD_entryRecord_t OD_record2003[8] = {
           {(void*)&CO_OD_ROM.configPort[1].highestSubIndexSupported, 0x05, 0x1 },
           {(void*)&CO_OD_ROM.configPort[1].port, 0x05, 0x5 },
           {(void*)&CO_OD_ROM.configPort[1].outputMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[1].outputStartValue, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[1].inputMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[1].inputPullUp, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[1].inputPullDown, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[1].availableMask, 0x85, 0x2 },
};

/*0x2004*/ const CO_OD_entryRecord_t OD_record2004[8] = {
           {(void*)&CO_OD_ROM.configPort[2].highestSubIndexSupported, 0x05, 0x1 },
           {(void*)&CO_OD_ROM.configPort[2].port, 0x05, 0x5 },
           {(void*)&CO_OD_ROM.configPort[2].outputMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[2].outputStartValue, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[2].inputMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[2].inputPullUp, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[2].inputPullDown, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configPort[2].availableMask, 0x85, 0x2 },
};

/*0x2005*/ const CO_OD_entryRecord_t OD_record2005[3] = {
           {(void*)&CO_OD_ROM.configADC.highestSubIndexSupported, 0x05, 0x1 },
           {(void*)&CO_OD_ROM.configADC.cannelsMask, 0x8D, 0x2 },
           {(void*)&CO_OD_ROM.configADC.availableMask, 0x85, 0x2 },
};
...
{0x2101, 0x00, 0xB7,  4, (void*)&CO_OD_EEPROM.powerOnCounter},
{0x6100, 0x04, 0xFE,  2, (void*)&CO_OD_RAM.readInput16Bit[0]},
{0x6300, 0x04, 0xBE,  2, (void*)&CO_OD_RAM.writeOutput16Bit[0]},
{0x6400, 0x10, 0x36,  1, (void*)&CO_OD_RAM.readAnalogueInput8Bit[0]},
